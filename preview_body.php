    ...
    <div class="columns level">
      ...
      <div class="column level-left">
        ...
        <div class="card">
          ...
          <div class="card-content">
            <!-- Title -->
            <p class="title is-6"><?php echo $_SESSION["preview_title"]; ?></p>
            <hr><!-- Insert php document title -->
      ...
      <div class="column level-right">
        ...
        <div class="card">
          <div class="card-content">
            <!-- Details -->
            <p class="title is-6 has-text-left">About</p>
            <hr>
            ...
            <p class="is-6 has-text-left">Date Published: <?php $dateTime = new DateTime($_SESSION["preview_date_created"]);
                                                          echo date_format($dateTime, "M. d, Y"); ?></p>
            <hr>
